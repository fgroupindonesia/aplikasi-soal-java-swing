...
public class DBConnection {
    ...
    public boolean delete_history_specific(String nama) {
        return this.delete_specific(DBTableDefinition.TABLE_HISTORY, new Conditional("username", nama));
    }
    ...
    public boolean verify_student(String name) {
        //String sql = "INSERT INTO table_category(nama, tanggal) VALUES(?,?)";
        qb.addConditional(new Conditional("nama", name.toLowerCase(), true));
        ...
        try {
            ...
            System.out.println("Error at verify_student() " + e.getMessage());
        }
    ...
    public ArrayList<History> select_history_specific(String username, String keyword) {
        //String sql = "INSERT INTO table_category(nama, tanggal) VALUES(?,?)";
        qb.addConditional(new Conditional("username", username));
        qb.addConditional(new Conditional("description", keyword));
        ...
        try {
            ...
            System.out.println("Error at select_history_specificl() " + e.getMessage());
        }
    ...
    public Rewards select_rewards_specific(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                item.setJenis(rs.getString("jenis"));
            }
    ...
    public void insert_rewards(Rewards data) {
        ...
        try {
            ...
            pstmt.setString(4, data.getJenis());
